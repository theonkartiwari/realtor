        ...
        <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
            ...
            <div>
                <ul className='flex space-x-10'>
                    <li className={`cursor-pointer py-3 text-sm font-semibold text-green-400 border-b-[3px] border-b-transparent
                    ...
                    <li className={`cursor-pointer py-3 text-sm font-semibold text-green-400 border-b-[3px] border-b-transparent
                    ${pathMathRoute("/sign-in") && "text-black border-b-red-500"}`}   onClick ={()=>navigate("/sing-in")}>Sign in</li>
                </ul>
            </div>
        </header>
    </div>
